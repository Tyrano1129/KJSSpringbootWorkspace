...
public class MemberJapRepository {
    private final EntityManager em; // 순수 jpa 쿼리 작성시 필요하다
    ...
    public List<Member> findAll_QueryDsl(){
        // QMember.member -> alt+enter -> static 변수로 만들수 있음
        return queryFactory
                .selectFrom(member)
                .fetch();
    }
...
//회원명, 팀명, 나이(ageGoe, ageLoe)
    //import static org.springframework.util.StringUtils.hasText; ==> null 과 빈문자열 체크
